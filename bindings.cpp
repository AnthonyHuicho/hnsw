...
public:
    ...
    void set_aqr_params(float tau_gap, float tau_ratio, size_t n_rerank, bool enabled = true)
    {
    if (appr_alg)
        appr_alg->setAqrParams(tau_gap, tau_ratio, n_rerank, enabled);
    }
